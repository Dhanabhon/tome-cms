...
รหัสจะถูกใช้ไปทันทีที่เซิร์ฟเวอร์รับ และทุกอุปกรณ์ที่เจ้าของเว็บเข้าสู่ระบบค้างไว้จะถูกออกจากระบบในตอนนั้น รหัสนี้เปิดลิงก์กู้คืนแบบใช้ครั้งเดียวที่มีอายุสิบนาที ถ้าสร้าง Passkey ไม่สำเร็จ หน้าจะเก็บลิงก์ไว้ให้ กด "สร้าง Passkey สำหรับกู้คืน" เพื่อลองใหม่ได้ตราบที่ลิงก์ยังไม่หมดอายุ ถ้าเกินสิบนาทีแล้ว ต้องเริ่มใหม่ด้วยรหัสอื่น

ถ้ารหัสผิดหรือถูกใช้ไปแล้ว หน้าจะแจ้งเป็นภาษาอังกฤษว่า "Check the recovery code and try again." ลองได้ห้าครั้งภายใน 30 นาทีต่อหนึ่ง IP หลังจากนั้นต้องรอสักพัก
...
เวลาที่แสดงเป็น UTC ให้เปิดลิงก์บนอุปกรณ์ที่จะเก็บ Passkey ตัวใหม่ แล้วกด "สร้าง Passkey สำหรับกู้คืน" ในส่วน "สร้าง Passkey ทดแทน" จากนั้นทุกอย่างเป็นแบบเดียวกับการใช้รหัส คือ Passkey ตัวใหม่จะมาแทน Passkey เก่าทุกตัว ส่วนรหัสกู้คืนที่เก็บไว้ยังใช้ได้เหมือนเดิม
