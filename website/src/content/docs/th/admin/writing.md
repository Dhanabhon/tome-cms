...
"ทำสำเนา" สร้างฉบับร่างใหม่จากฉบับนั้น เป็นภาษาเดียวกัน มี "(สำเนา)" ต่อท้ายชื่อเรื่อง และได้หมวดหมู่ชุดเดียวกัน สำเนานี้เป็นบทความแยกอีกเรื่องหนึ่ง ไม่ได้เป็นอีกภาษาของบทความเดิม ส่วน "ลบ" จะลบเฉพาะฉบับภาษานั้น และย้อนกลับไม่ได้
...
"ดูตัวอย่าง" จะบันทึกบทความ แล้วเปิดในแท็บใหม่ตามหน้าตาของธีมที่เว็บใช้อยู่ แม้บทความยังเป็นฉบับร่าง ปุ่มนี้ต้องมีชื่อเรื่องก่อนจึงจะกดได้
...
"ลิงก์" จะเปิดกล่อง "เพิ่มลิงก์" วางที่อยู่ที่ขึ้นต้นด้วย `http` หรือ `https` ลงในช่อง "ที่อยู่ URL" แล้วกด "ใส่ลิงก์" ตัวเลือก "เปิดในแท็บใหม่" เปิดไว้ตั้งแต่แรก ถ้าอยากให้ลิงก์เปิดในแท็บเดิมก็ปิดตัวเลือกนี้ จะเอาลิงก์ออก ให้เลือกข้อความที่มีลิงก์แล้วกด "ลิงก์" อีกครั้ง
...
| ช่อง | ใช้ทำอะไร |
| --- | --- |
| "ชื่อใน URL" | ที่อยู่ของบทความ ต่อจาก `/th/blog/` หรือ `/en/blog/` ค่านี้จะเปลี่ยนตามชื่อเรื่องไปเรื่อย ๆ จนกว่าคุณจะแก้เอง ชื่อเรื่องภาษาไทยได้ที่อยู่เป็นภาษาไทย โดยมีขีดกลางคั่นระหว่างคำ |
...
| "คำอธิบายสำหรับผลค้นหา" | แสดงใต้ชื่อบทความ และใช้ในผลการค้นหากับตอนแชร์บทความ ยาวไม่เกิน 320 ตัวอักษร |
...
ถ้าเปิดปลั๊กอิน "Jev (TypeSafe AI)" ไว้ที่ "หน้าตาเว็บไซต์" แล้วเลือก "ปลั๊กอิน" แผงตั้งค่าจะมีปุ่มเพิ่มมาสามปุ่ม "เสนอจากเนื้อหา" เสนอหมวดหมู่จากหมวดที่คุณมีอยู่แล้ว "เสนอประโยคจากเนื้อหา" หยิบประโยคจากบทความมาเสนอเป็นข้อความย่อ และ "เสนอคำอธิบายจากเนื้อหา" หยิบมาเสนอเป็นคำอธิบายสำหรับผลค้นหา

ระบบไม่กรอกอะไรให้เอง หมวดหมู่ที่เสนอมาเป็นป้ายที่คุณต้องกดเองจึงจะเพิ่ม ส่วนประโยคที่เสนอก็มีปุ่ม "ใช้ประโยคนี้" หรือ "ใช้เป็นคำอธิบาย" ของมันเอง เนื้อหาของบทความจะถูกส่งไปที่ TypeSafe AI เฉพาะตอนที่คุณกดหนึ่งในสามปุ่มนี้เท่านั้น ถ้าไม่ได้เปิดปลั๊กอิน ปุ่มเหล่านี้จะไม่มีให้เห็น
