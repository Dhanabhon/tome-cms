...
description: เขียนบทความในหน้าแก้ไข ใส่ภาพ ไฟล์ ตาราง และวิดีโอ แล้วกรอกการตั้งค่าของบทความก่อนเผยแพร่
sidebar:
  order: 1
---
...
พิมพ์ `/` ที่ต้นบรรทัดหรือหลังเว้นวรรค จะมีเมนูขึ้นมา ได้แก่ "หัวข้อระดับ 2" "หัวข้อระดับ 3" "รายการแบบจุด" "บล็อกโค้ด" "คำพูดอ้างอิง" "ตาราง" "ไฟล์" และ "วิดีโอ" พิมพ์ต่อเพื่อกรองรายการ แล้วกด Enter เพื่อเลือก
...
วางลิงก์ YouTube หรือ Vimeo ลงในบรรทัดว่างโดยไม่มีอะไรอื่น ลิงก์นั้นจะกลายเป็นวิดีโอ ถ้าวางกลางประโยค หรือวางในบรรทัดว่างที่อยู่ในตาราง รายการ หรือคำพูดอ้างอิง ลิงก์จะยังเป็นลิงก์ธรรมดา อีกทางหนึ่งคือเลือก "วิดีโอ" จากเมนู "+" หรือเมนู `/` ซึ่งมีให้เลือกเมื่อเคอร์เซอร์ไม่ได้อยู่ในตาราง กล่อง "ใส่วิดีโอ" จะเปิดขึ้น วางลิงก์ลงในช่อง "ลิงก์" แล้วกด Enter ถ้าลิงก์ไม่ได้ชี้ไปที่คลิปเดียวของ YouTube หรือ Vimeo จะขึ้นว่า "ใช้ลิงก์ YouTube หรือ Vimeo ที่ชี้ไปที่คลิปเดียว"

วิดีโอจะเข้าไปอยู่ในบทความทันทีเป็นการ์ดที่บอกรหัสของคลิปกับ "YouTube" หรือ "Vimeo" อีกครู่หนึ่งการ์ดจะขึ้นชื่อคลิปและภาพปก ซึ่งเซิร์ฟเวอร์ดึงมาจาก YouTube หรือ Vimeo แล้วเก็บไว้ในคลังไฟล์ การ์ดนี้ย้ายและลบได้เหมือนบล็อกอื่น

ถ้า YouTube หรือ Vimeo ไม่ให้ชื่อและภาพปกมา หน้าแก้ไขจะบอกเหตุผลภายใต้หัวข้อ "ใส่วิดีโอแล้ว แต่ไม่มีภาพปก" เช่น คลิปอาจเป็นแบบส่วนตัว หรือเซิร์ฟเวอร์ติดต่อ YouTube หรือ Vimeo ไม่ทันเวลา คลิปยังอยู่ในบทความโดยไม่มีภาพปก และยังเผยแพร่ได้ ผู้อ่านที่มีสิทธิ์ดูคลิปนั้นก็ยังกดเล่นได้

บนเว็บ ผู้อ่านจะเห็นภาพปกพร้อมเครื่องหมายเล่น และจะไม่มีอะไรโหลดจาก YouTube หรือ Vimeo จนกว่าผู้อ่านจะกดเล่น หน้า[สิ่งที่เบราว์เซอร์ของผู้อ่านเก็บไว้](/tome-cms/th/running/privacy/) อธิบายว่าหลังจากนั้นเกิดอะไรขึ้น
