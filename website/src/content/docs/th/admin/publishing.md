...
เปิด "ตั้งค่า" ในหน้าแก้ไข ใส่วันและเวลาในช่อง "เผยแพร่เมื่อ" แล้วกด "เผยแพร่" บทความจะยังไม่ขึ้นเว็บจนถึงเวลานั้น ที่อยู่ของบทความจะตอบ `404` และบทความจะไม่อยู่ในหน้าแรก ในฟีดหรือ sitemap ในหมวดหมู่ ในเมนู หรือใน content API ส่วนในรายการบทความของหน้าแอดมิน บทความจะอยู่ใต้แท็บ "เผยแพร่แล้ว" และมีป้าย "รอเผยแพร่" ป้ายภาษาในหน้าแก้ไขก็ขึ้นว่า "รอเผยแพร่" เช่นกัน เมื่อถึงเวลา บทความจะขึ้นเว็บเองโดยไม่ต้องกดอะไรอีก
...
ฉบับร่างเก็บวันที่ที่ตั้งไว้ให้ จึงตั้งเวลาไว้ก่อน แล้วค่อยกด "เผยแพร่" วันหลังก็ได้ ถ้าต้องการเผยแพร่ตามวันที่ตั้งไว้ ให้กด "เผยแพร่" ในหน้าแก้ไข ส่วน "เผยแพร่" ในรายการจะเผยแพร่ทันทีและลบวันที่ที่ตั้งไว้ทิ้งไป ถ้าเว้นช่อง "เผยแพร่เมื่อ" ว่างไว้ จะหมายถึงเผยแพร่ทันที ส่วนวันที่ที่ผ่านไปแล้วจะเผยแพร่บทความทันที โดยลงวันที่ตามที่ใส่ไว้
