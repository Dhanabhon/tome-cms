...
- `siteNotice` คืนข้อความกับลิงก์ได้ไม่เกินหนึ่งลิงก์ ใส่สีของแถบเป็น `#rrggbb` และ key ที่ใช้จำว่าผู้อ่านปิดแถบไปแล้วได้ถ้าต้องการ แกนระบบวาดแถบเอง มีปุ่มปิดเมื่อมี key และทิ้งลิงก์ที่ไม่ได้อยู่บนเว็บนี้และไม่ใช่ `https`
- `sitePopup` คืนหัวข้อ ข้อความ ลิงก์หนึ่งลิงก์ และรูปจากคลังไฟล์ตาม id แกนระบบตรวจลิงก์แบบเดียวกัน และวาดรูปก็ต่อเมื่อรูปนั้นยังเป็นรูปที่พร้อมใช้ในคลังของเจ้าของเว็บ
