...
TomeCMS is at version 0.12.1, and there is no 1.0.0 release yet. What you can install today is a preview. The deploy helper builds the application on your own server from a checkout of the code, and you upgrade by running it again from a newer checkout.
