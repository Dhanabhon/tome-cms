...
export const ADMIN_NAV_IDS = ['posts', 'pages', 'media', 'navigation', 'slides', 'redirects', 'profile', 'security', 'siteSettings', 'settings', 'maintenance', 'appearance', 'themes', 'plugins', 'system'] as const;
