...
function detectedType(buffer: Buffer): SupportedImageType | null {
...
export async function inspectImage(
  ...
  if (detectedType(buffer) !== expectedType) throw new Error('The uploaded bytes do not match the selected image type.');
