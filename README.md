...
The application's migrations are applied with `npm run db:migrate`, and the deploy helper runs them for you. An installation created from 0.10.0 has two waiting, `024_site_maintenance` and `025_content_stats`. One created from 0.9.0 or 0.8.0 has three, those and `023_home_slides`. One created from 0.7.0 or 0.6.0 has five, those, `021_media_documents` and `022_navigation_new_tab`. One created from 0.5.0 or 0.4.0 has six, those and `020_site_brand`. One created from 0.3.0 has nine, and one from before 0.3.0 has those and nine more; see the [0.11.0](docs/releases/0.11.0.md#upgrading), [0.10.0](docs/releases/0.10.0.md#upgrading), [0.8.0](docs/releases/0.8.0.md#upgrading), [0.6.0](docs/releases/0.6.0.md#upgrading), [0.4.0](docs/releases/0.4.0.md#upgrading) and [0.3.0](docs/releases/0.3.0.md#upgrading) notes. The admin names any migration it finds unapplied at the top of every screen.
